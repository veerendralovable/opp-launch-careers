...
const Bookmarks = () => {
  ...
  if (loading && !initialized) {
    return <LoadingSpinner fullScreen size="lg" message="Loading your bookmarks..." />;
  }
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-muted/30 flex items-center justify-center">
        <div className="text-center">
          <p className="text-muted-foreground mb-4">Please sign in to view your bookmarks</p>
          <Link to="/auth">
      ...
      <div className="bg-card border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              <h1 className="text-3xl font-bold text-foreground">Bookmarked Opportunities</h1>
              <p className="text-muted-foreground mt-2">Your saved opportunities ({bookmarkedOpportunities.length})</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {bookmarkedOpportunities.length > 0 ? (
          ...
          <div className="text-center py-12">
            <Bookmark className="h-24 w-24 text-muted-foreground/50 mx-auto mb-4" />
